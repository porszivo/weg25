...
export class DeviceService {
    ...
    private listDevicesURL = 'http://localhost:8080/listDevices';
    private updateDeviceURL = 'http://localhost:8080/updateDevice';
    private deleteDeviceURL = 'http://localhost:8080/deleteDevice';
    private createDeviceURL = 'http://localhost:8080/createDevice';
    ...
    updateCurrent(device: Device, new_value: number, controlUnit: ControlUnit): void {
        ...
        request.open('POST', 'http://localhost:8080/updateCurrent', true);
    ...
    openWebsocket(): void {
        ...
        this.connection = new WebSocket('ws://localhost:8080/subscribe');
